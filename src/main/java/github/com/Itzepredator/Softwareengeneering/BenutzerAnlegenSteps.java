...
public class BenutzerAnlegenSteps {
	...
	@Dann("^bekommt der Benutzer eine BestÃ¤tigung, dass der Vorgang erfolgreich abgeschlossen wurde$")
	public void bekommt_der_Benutzer_eine_BestÃ¤tigung_dass_der_Vorgang_erfolgreich_abgeschlossen_wurde() throws Throwable {
	    // Express the Regexp above with the code you wish you had
	    throw new PendingException();
	}
